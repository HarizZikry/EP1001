...
The handbrake itself will made of wood. I'll be using the CNC mill to fabricate it. Here are the designs and layout:
...
I need to create a gear set and mount for the potentiometer.
